...
def launch_setup(context, *args, **kwargs):
    ...
    data_collecting_pure_pursuit_trajectory_follower = Node(
    ...
    data_collecting_trajectory_publisher = Node(
        package="control_data_collecting_tool",
...
def generate_launch_description():
    ...
    add_launch_arg(
        ...
        "Options for which trajectory_follower to use. Options: `trajectory_follower_node`, `smart_mpc_trajectory_follower`, `data_collecting_pure_pursuit_trajectory_follower`",
    )
